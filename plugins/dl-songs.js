    ...
    if (command == 'play4' || command == 'playdoc2') {
      try {
        ...
        try {
          ...
          await conn.sendMessage(m.chat, { video: { url: mediaa.result }, caption: mediaa.title, mimetype: 'video/mp4', fileName: `${mediaa.title}.mp4` }, { quoted: m });
        } catch {
          try {
            ...
            await conn.sendMessage(m.chat, { video: { url: n2 }, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `▢ 𝚃𝙸𝚃𝚄𝙻𝙾: ${n}` }, { quoted: m });
          } catch {
...
function secondString(seconds) {
  ...
  return dreturn dDisplay + hDisplay + mDisplay + sDisplay;
}
